...
1. `docker build -t achandra1258/my-pal-json:{version} .`docker run --name my-pal-json-server-app -d -p 5000:5000 achandra1258/my-pal-json:{tagname}k
2. `docker tag achandra1258/my-pal-json:1.0.4 achandra1258/my-pal-json:latest`
